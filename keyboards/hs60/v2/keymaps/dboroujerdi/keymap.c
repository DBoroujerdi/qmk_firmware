...
[1] = LAYOUT_60_ansi( /* FN */
    ...
    KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_PSCR,  KC_SLCK,  KC_BRK,   KC_UP,    RESET,    KC_TRNS,\
    KC_TRNS,  KC_VOLU,  KC_VOLD,  KC_MUTE,  KC_EJCT,  KC_TRNS,  KC_PAST,  KC_PSLS,  KC_HOME,  KC_PGDN,  KC_LEFT,  KC_RGHT,            KC_TRNS,\
    KC_TRNS,            KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_PPLS,  KC_PMNS,  KC_END,   KC_PGDN,  KC_DOWN,            KC_TRNS,\
    KC_TRNS,  KC_TRNS,  KC_TRNS,                                KC_TRNS,                                MO(2),    KC_TRNS,  KC_TRNS,  KC_TRNS),

[2] = LAYOUT_60_ansi( /* FN2 - lighting effects */
